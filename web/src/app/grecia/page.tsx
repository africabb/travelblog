    ...
    <section className="mb-16 border-y border-black/[0.07] py-10">
      ...
      {groups.length > 0 ? (
        <div>
          ...
          {groups.map((group) => (
            <div key={group.place.name} className="grid grid-cols-1 sm:grid-cols-[minmax(0,0.8fr)_minmax(0,1fr)_minmax(0,1fr)] gap-4 sm:gap-5 py-5 sm:py-4 first:pt-0 last:pb-0">
